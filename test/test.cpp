...
UNITTEST(ChangeLevelDynamically)
{
	...
	const LOGOG_CHAR *levelDescriptions[] = {
		...
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_ALERT"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_CRITICAL"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_ERROR"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_WARN"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_WARN1"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_WARN2"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_WARN3"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_INFO"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_DEBUG"),
		(const LOGOG_CHAR *)_LG("LOGOG_LEVEL_ALL")
	};

...
/** The default time format used to render the time. */
...
public:
	...
	/** Sets the time format used to render the time. It will be passed to strftime, defaults to LOGOG_DEFAULT_TIME_FORMAT.*/
...
protected:
    ...
    LOGOG_STRING m_TimeOfDayFormat;
